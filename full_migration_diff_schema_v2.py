...
MYSQL_CONFIG = {
    ...
    "user": "root",
    "password": "root",
    "database": "elaboffice_cen_23Feb26"
}
...
PG_CONFIG = {
    ...
    "user": "postgres",
    "password": "postgres",
    "dbname": "elaboffice_cen_04Mar26_2",
    "schema": "elab"
}
...
def to_snake_case(name):
    ...
    # Remove known prefixes (with or without underscore)
    # prefixes = ("dt_", "dt", "d_", "d", "t_", "t", "n_", "n")
    prefixes = ("dt_", "d_", "t_", "n_")
